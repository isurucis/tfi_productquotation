...
<div class="panel" id="fmm_promo_panel">
  <div class="col-lg-3">
    <ul>
      <li><a href="{$smarty.const.__PS_BASE_URI__|escape:'htmlall':'UTF-8'}modules/productquotation/readme_en.pdf" target="_blank" title="Need Help">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE887;</i>{else}<i class="icon-question-circle"></i>{/if}Help?</a></li>
      <li class="color_red"><a href="https://addons.prestashop.com/contact-form.php?id_product=21854" target="_blank" title="Need Support">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE0C6;</i>{else}<i class="icon-comments"></i>{/if}Support</a></li>
      <li class="color_blue"><a href="https://addons.prestashop.com/en/quotes/21854-product-quotation-allow-customer-to-ask-for-quote.html" target="_blank" title="Need Details">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE8F4;</i>{else}<i class="icon-eye"></i>{/if}Details</a></li>
  ...
  <div class="col-lg-7 fmm_promo_modules">
    <ol>
      ...
      <li><a href="https://addons.prestashop.com/en/seo-natural-search-engine-optimization/43460-meta-tag-manager-autogenerate-seo-title-description.html" target="_blank" title="Meta Tag Manager"><img src="https://www.fmemodules.com/1428-home_default/meta-tag-manager.jpg" alt="" /><i>Meta Tag Manager Module</i></a></li>
      <li><a href="https://addons.prestashop.com/en/seo-natural-search-engine-optimization/43048-seo-alt-images-tags.html" target="_blank" title="SEO Alt Images Tags"><img src="https://www.fmemodules.com/2194-home_default/seo-alt-images-tags-module.jpg" alt="" /><i>Alt Images Tags Module</i></a></li>
    </ol>
  </div>
